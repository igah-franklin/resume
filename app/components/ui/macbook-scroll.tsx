...
import profilePic from '../../../public/assets/jpg/profile-pic.jpeg'
  ...
  return (
    <div className="relative [perspective:800px]">
      ...
      >
        ...
        />
        <h4>hello there</h4> */}
        <div className='absolute inset-0 text-white p-3'>
            <p>
            - I am a <b className="text-yellow-800">Fullstack Engineer</b> with extensive experience in building scalable, high-performance <b className="text-yellow-800">web</b> and <b className="text-yellow-800">mobile applications</b>. <br /><br /> - Strong design sense with deep knowledge of modern technologies. <br /> <br />
            - skilled in translating UI/UX designs into dynamic, interactive pages while ensuring scalability, performance, responsive design, accessibility, SEO optimization, and clean architecture.
            </p>
        </div>
      </motion.div>
    </div>
